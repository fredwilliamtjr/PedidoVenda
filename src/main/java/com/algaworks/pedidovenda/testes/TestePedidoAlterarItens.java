...
public class TestePedidoAlterarItens {
    ...
    public static void main(String[] args) {
        ...
        Pedido pedido = manager.find(Pedido.class, 7L);
        pedido.getItens().get(2).setQuantidade(222);
        Produto produto1 = manager.find(Produto.class, 2L);
        ItemPedido item1 = new ItemPedido();
        item1.setProduto(produto1);
        item1.setQuantidade(666);
        item1.setValorUnitario(new BigDecimal(9.32));
